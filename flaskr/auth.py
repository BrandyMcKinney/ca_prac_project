"""Creating Blueprint for authentication"""
...
# creates a Blueprint named 'auth', __name__ is where Blueprint is defined 
bp = Blueprint('auth', __name__, url_prefix='/auth')

"""after registering view in the factory __init__.py, the blueprint now has views to register
new users, to log in and log out"""
...
"""User's id is now stored in a session"""
